-- Update create_cron_job function to include cleanup-old-records in allowlist
...
-- Update run_cron_job_now function to include cleanup-old-records in allowlist
